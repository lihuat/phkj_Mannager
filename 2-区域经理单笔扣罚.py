...
#导入区经区助免除扣罚名单
Free = pd.read_excel("输出/区经区助扣罚免除.xlsx",dtype={"区经工号_x":'O'})
Free = Free[["区经工号_x","是否免扣"]]
...
#区助是否免扣
Free_qz = Free.copy()
Free_qz = Free_qz.rename(index=str,columns={"区经工号_x":'区域经理助理编号'})
...
#区经是否免扣
Free_qj = Free.copy()
Free_qj = Free_qj.rename(index=str,columns={"区经工号_x":'区域经理编号'})
